...
import org.coupon.dao.CouponDao;
import org.coupon.entity.Coupon;
import org.coupon.exception.CouponException;
import org.coupon.feign.hystrix.TemplateClient;
import org.coupon.service.IRedisService;
import org.coupon.service.IUserService;
import org.coupon.vo.*;
...
public class UserServiceImpl implements IUserService {
    ...
    public UserServiceImpl(CouponDao couponDao, IRedisService redisService,
                           TemplateClient templateClient, KafkaTemplate<String, String> kafkaTemplate) {
    ...
    public List<Coupon> findCouponsByStatus(Long userId, Integer status) throws CouponException {
        ...
        if (CollectionUtils.isNotEmpty(curCached)){
           ...
           List<Coupon> dbCoupons = couponDao.findByUserIdAndStatus(userId, CouponStatus.of(status));
            ...
            Map<Integer, CouponTemplateSDK> templateSDKMap =
